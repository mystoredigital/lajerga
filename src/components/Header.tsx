...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-dark-900/95 backdrop-blur-sm border-b border-dark-700">
      {/* Banner publicitario */}
      <div className="w-full bg-dark-800 text-center py-2 text-sm text-dark-400 border-b border-dark-700">
        <div className="max-w-6xl mx-auto px-4">
          <div className="h-10 bg-dark-700 rounded flex items-center justify-center text-dark-500 text-xs">
